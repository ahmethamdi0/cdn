/*!
 * EverSarjTools v20241126095318 by Ever Şarj - https://eversarj.com
...
const pe = [], Fe = [];
let ye = [];
const ot = [], bn = /* @__PURE__ */ Promise.resolve();
let lt = !1;
function yn() {
  lt || (lt = !0, bn.then(G));
}
...
function cr(t, e, n, r, i, a, s, l, o, c, f, d) {
  ...
  const v = {};
  for (; p--; ) v[t[p].key] = p;
  const _ = [], w = /* @__PURE__ */ new Map(), b = /* @__PURE__ */ new Map(), j = [];
  for (p = m; p--; ) {
    const P = d(i, a, p), T = n(P);
    let E = s.get(T);
    E ? j.push(() => E.p(P, e)) : (E = c(T, P), E.c()), w.set(T, _[p] = E), T in v && b.set(T, Math.abs(p - v[T]));
  }
  ...
  for (; u && m; ) {
    ...
    P === T ? (f = P.first, u--, m--) : w.has(C) ? !s.has(E) || S.has(E) ? $(P) : x.has(C) ? u-- : b.get(E) > b.get(C) ? (x.add(E), $(P)) : (S.add(C), u--) : (o(T, s), u--);
  }
  for (; u--; ) {
    const P = t[u];
    w.has(P.key) || o(P, s);
...
function B(t, e, n) {
  ...
  r && r.m(e, n), Ge(() => {
    const a = t.$$.on_mount.map(pn).filter(vt);
...
class xn extends Y {
  constructor(e) {
    super(), W(this, e, br, vr, R, { size: 0 }, hr);
  }
  get size() {
    return this.$$.ctx[0];
  }
...
function Lr(t) {
  let e, n, r, i, a, s, l, o, c, f, d, u, m, p, v;
  const _ = (
    /*#slots*/
    t[4].title
  ), w = me(
  ...
  return {
    c() {
      e = y("section"), n = y("div"), r = z(), i = y("div"), a = z(), s = y("div"), l = y("h2"), b && b.c(), o = z(), c = y("p"), x && x.c(), f = z(), d = y("div"), P && P.c(), u = z(), m = y("div"), E && E.c(), h(n, "class", "step-count svelte-vf7xe1"), h(i, "class", "step-line svelte-vf7xe1"), h(l, "class", "step-header__title svelte-vf7xe1"), h(c, "class", "step-header__description svelte-vf7xe1"), h(d, "class", "step-header__actions svelte-vf7xe1"), h(s, "class", "step-header svelte-vf7xe1"), h(m, "class", "step-body svelte-vf7xe1"), h(e, "class", "step svelte-vf7xe1"), h(e, "id", p = "step-" + /*name*/
      t[0]);
    },
    m(C, D) {
      q(C, e, D), g(e, n), g(e, r), g(e, i), g(e, a), g(e, s), g(s, l), b && b.m(l, null), g(s, o), g(s, c), x && x.m(c, null), g(s, f), g(s, d), P && P.m(d, null), g(e, u), g(e, m), E && E.m(m, null), v = !0;
    },
    p(C, [D]) {
      w ? w.p && (!v || D & /*$$scope*/
      8) && ve(
      ...
      8) && ve(
        ...
        Ot
      ) : x && x.p && (!v || D & /*description*/
      4) && x.p(C, v ? D : -1), P && P.p && (!v || D & /*$$scope*/
      8) && ve(
        P,
        $,
        C,
    ...
    i(C) {
      v || (k(b, C), k(x, C), k(P, C), k(E, C), v = !0);
    },
    o(C) {
      A(b, C), A(x, C), A(P, C), A(E, C), v = !1;
    },
    d(C) {
      C && O(e), b && b.d(C), x && x.d(C), P && P.d(C), E && E.d(C);
    }
  };
}
function Br(t, e, n) {
...
function Fi(t, e) {
    ...
    if (b !== void 0)
      switch (w) {
        ...
        case "vFlip":
          ...
          break;
        case "flip":
          typeof b == "string" && Ti(n, b);
          break;
        case "color":
          a = a + (a.length > 0 && a.trim().slice(-1) !== ";" ? ";" : "") + "color: " + b + "; ";
          break;
        case "rotate":
          typeof b == "string" ? n[w] = Di(b) : typeof b == "number" && (n[w] = b);
          break;
        case "ariaHidden":
        case "aria-hidden":
  ...
  if (n.inline && (a = "vertical-align: -0.125em; " + a), r === "svg") {
    ...
    return typeof b == "string" && (b = b.replace(/-/g, "_")), {
      svg: !0,
      attributes: i,
      body: ai(s.body, b ? () => b + "ID" + w++ : "iconifySvelte")
    };
  }
  ...
  v("width"), v("height"), Object.assign(p, Ni, d ? mt : Bn);
  let _ = "";
  for (const w in p)
    _ += w + ": " + p[w] + ";";
  return i.style = _ + a, {
...
function Xi(t, e, n) {
  ...
  let i = !1, a = 0, s;
  const l = (c) => {
    typeof e.onLoad == "function" && e.onLoad(c), vn()("load", { icon: c });
  };
  function o() {
    n(3, a++, a);
  }
...
function la(t) {
  let e, n, r, i, a, s, l, o, c, f, d, u, m, p, v, _ = (
    /*meta*/
    t[1].batteryCapacity + ""
  ), w, b, j, S, x, $, P, T, E = (
    /*meta*/
  ...
  return m = new Se({ props: { name: "ri:battery-low-line" } }), $ = new Se({ props: { name: "ri:plug-line" } }), {
    c() {
      e = y("button"), n = y("span"), N(r.$$.fragment), i = z(), a = y("span"), s = y("span"), l = y("span"), o = L(
        /*name*/
        t[2]
      ), c = z(), K && K.c(), f = z(), d = y("span"), u = y("span"), N(m.$$.fragment), p = z(), v = y("span"), w = L(_), b = L(` kW
          `), j = y("i"), j.textContent = "Batarya", S = z(), x = y("span"), N($.$$.fragment), P = z(), T = y("span"), C = L(E), D = L(` kW
          `), M = y("i"), M.textContent = "Maksimum AC Gücü", h(n, "class", "card-image svelte-t5ros6"), h(l, "class", "card-content-header__name svelte-t5ros6"), h(s, "class", "card-content-header svelte-t5ros6"), h(j, "class", "svelte-t5ros6"), h(v, "class", "svelte-t5ros6"), h(u, "class", "card-content-info__item svelte-t5ros6"), h(M, "class", "svelte-t5ros6"), h(T, "class", "svelte-t5ros6"), h(x, "class", "card-content-info__item svelte-t5ros6"), h(d, "class", "card-content-info svelte-t5ros6"), h(a, "class", "card-content svelte-t5ros6"), h(e, "class", "card svelte-t5ros6"), _e(
        e,
        "selected",
        /*$selectedModel*/
        t[5] === /*slug*/
    ...
    m(F, ne) {
      q(F, e, ne), g(e, n), B(r, n, null), g(e, i), g(e, a), g(a, s), g(s, l), g(l, o), g(s, c), K && K.m(s, null), g(a, f), g(a, d), g(d, u), B(m, u, null), g(u, p), g(u, v), g(v, w), g(v, b), g(v, j), g(d, S), g(d, x), B($, x, null), g(x, P), g(x, T), g(T, C), g(T, D), g(T, M), U = !0, I || (le = We(
        e,
        "click",
        /*onSelect*/
        t[6]
...
function fa(t) {
  ...
  return {
    ...
    m(p, v) {
      q(p, e, v), g(e, n), g(n, r), B(i, r, null), g(n, a), g(n, s), g(n, l), g(n, o), g(e, c);
    ...
    p(p, v) {
      ...
      2) {
        ...
        for (_ = 0; _ < d.length; _ += 1) {
          const w = en(p, d, _);
          u[_] ? (u[_].p(w, v), k(u[_], 1)) : (u[_] = nn(w), u[_].c(), k(u[_], 1), u[_].m(e, null));
        }
...
class ht extends Y {
  constructor(e) {
    super(), W(this, e, ba, va, R, { icon: 0, title: 1, value: 2 }, ha);
  }
  get icon() {
    return this.$$.ctx[0];
  }
...
function cn(t) {
  ...
  return {
    c() {
      var b, j;
      e = y("div"), n = y("div"), r = y("span"), a = L(i), s = L(" ("), o = L(l), c = L(")"), f = z(), w && w.c(), d = z(), u = y("div"), _ = z(), h(n, "class", "calculate-item__title svelte-1k9u7p2"), h(u, "class", "calculate-item__bar svelte-1k9u7p2"), Ve(
        u,
        "--width",
        /*width*/
        t[12]
      ), h(u, "data-hour", m = /*time*/
      ((b = t[11]) == null ? void 0 : b.hour) + " Saat"), h(u, "data-minute", p = /*time*/
      ((j = t[11]) == null ? void 0 : j.minute) + " Dakika"), h(u, "data-available", v = /*time*/
      t[11] ? !0 : (
        /*error*/
        t[13]
    ...
    m(b, j) {
      q(b, e, j), g(e, n), g(n, r), g(r, a), g(r, s), g(r, o), g(r, c), g(n, f), w && w.m(n, null), g(e, d), g(e, u), g(e, _);
    },
    p(b, j) {
      var S, x;
      j & /*bars*/
      ...
      2 && l !== (l = /*phase*/
      b[9] + "") && H(o, l), /*time*/
      b[11] ? w ? w.p(b, j) : (w = ln(b), w.c(), w.m(n, null)) : w && (w.d(1), w = null), j & /*bars*/
      2 && Ve(
        u,
        "--width",
        /*width*/
      ...
      2 && m !== (m = /*time*/
      ((S = b[11]) == null ? void 0 : S.hour) + " Saat") && h(u, "data-hour", m), j & /*bars*/
      2 && p !== (p = /*time*/
      ((x = b[11]) == null ? void 0 : x.minute) + " Dakika") && h(u, "data-minute", p), j & /*bars*/
      2 && v !== (v = /*time*/
      b[11] ? !0 : (
        /*error*/
        b[13]
      )) && h(u, "data-available", v);
    },
    d(b) {
      b && O(e), w && w.d();
    }
  ...
  return {
    c() {
      ...
      for (let M = 0; M < D.length; M += 1)
        D[M].c();
      _ = z(), w = y("div"), b = L("*"), S = L(j), x = L(` kadar şarj ederken yaklaşık değerlerin belirlenmesi: gerçek şarj süresi ve şarj hızı, yuvarlama farklılıkları
    ve dış etkiler nedeniyle sapabilir.`), h(r, "class", "calculate-header__title svelte-1k9u7p2"), h(l, "class", "svelte-1k9u7p2"), h(d, "class", "svelte-1k9u7p2"), h(a, "class", "calculate-header__description svelte-1k9u7p2"), h(m, "class", "calculate-header__select svelte-1k9u7p2"), /*type*/
      t[0] === void 0 && Ge(() => (
        ...
        t[4].call(m)
      )), h(n, "class", "calculate-header svelte-1k9u7p2"), h(v, "class", "calculate-content svelte-1k9u7p2"), h(w, "class", "calculate-helper svelte-1k9u7p2"), h(e, "class", "calculate svelte-1k9u7p2");
    },
    m(M, U) {
      ...
      for (let I = 0; I < D.length; I += 1)
        D[I] && D[I].m(v, null);
      g(e, _), g(e, w), g(w, b), g(w, S), g(w, x), $ || (P = We(
        m,
        "change",
        /*select_change_handler*/
        t[4]
    ...
    p(M, [U]) {
      ...
      2) {
        ...
        for (I = 0; I < C.length; I += 1) {
          const le = an(M, C, I);
          D[I] ? D[I].p(le, U) : (D[I] = cn(le), D[I].c(), D[I].m(v, null));
        }
        for (; I < D.length; I += 1)
          D[I].d(1);
        D.length = C.length;
...
function fn(t) {
  ...
  return {
    ...
    m(v, _) {
      q(v, e, _), g(e, n), B(r, n, null), g(e, i), g(e, a), g(a, s), g(s, o), g(s, c), g(s, d), g(a, u), p && p.m(a, null), m = !0;
    },
    p(v, _) {
      const w = {};
      _ & /*brand, details*/
      5 && (w.src = "/brands/" + /*brand*/
      v[0].slug + "/models/" + /*details*/
      v[2].slug + "/banner.png"), _ & /*details*/
      4 && (w.alt = /*details*/
      v[2].name + " Banner"), r.$set(w), (!m || _ & /*brand*/
      1) && l !== (l = /*brand*/
      v[0].name + "") && H(o, l), (!m || _ & /*details*/
      4) && f !== (f = /*details*/
      v[2].name + "") && H(d, f), /*details*/
      v[2].description ? p ? p.p(v, _) : (p = un(v), p.c(), p.m(a, null)) : p && (p.d(1), p = null);
    },
    i(v) {
      m || (k(r.$$.fragment, v), m = !0);
    },
    o(v) {
      A(r.$$.fragment, v), m = !1;
    },
...
function ka(t) {
  let e, n = (
    ...
    /*details*/
    t[2].slug
  ), u, m, p, v, _ = !/*$getDetails*/
  t[1].hasOwnProperty("slug"), w, b = fn(t);
  s = new ht({
    props: {
  ...
  return {
    c() {
      e = y("div"), b.c(), r = z(), i = y("div"), a = y("div"), N(s.$$.fragment), l = z(), N(o.$$.fragment), c = z(), f = y("div"), j.c(), u = z(), m = y("div"), N(p.$$.fragment), v = z(), S && S.c(), h(a, "class", "details-content__info svelte-119ljc0"), h(f, "class", "details-content__calculate svelte-119ljc0"), h(m, "class", "details-content__product svelte-119ljc0"), h(i, "class", "details-content svelte-119ljc0"), h(e, "class", "details svelte-119ljc0"), _e(e, "details--empty", !/*$getDetails*/
      t[1].hasOwnProperty("slug"));
    },
    m(x, $) {
      q(x, e, $), b.m(e, null), g(e, r), g(e, i), g(i, a), B(s, a, null), g(a, l), B(o, a, null), g(i, c), g(i, f), j.m(f, null), g(i, u), g(i, m), B(p, m, null), g(e, v), S && S.m(e, null), w = !0;
    },
    p(x, $) {
      $ & /*details*/
      4 && R(n, n = /*details*/
      x[2].slug) ? (ae(), A(b, 1, 1, V), se(), b = fn(x), b.c(), k(b, 1), b.m(e, r)) : b.p(x, $);
      const P = {};
      $ & /*details*/
      4 && (P.value = /*details*/
    ...
    i(x) {
      w || (k(b), k(s.$$.fragment, x), k(o.$$.fragment, x), k(j), k(p.$$.fragment, x), k(S), w = !0);
    },
    o(x) {
      A(b), A(s.$$.fragment, x), A(o.$$.fragment, x), A(j), A(p.$$.fragment, x), A(S), w = !1;
    },
    d(x) {
      x && O(e), b.d(x), Q(s), Q(o), j.d(x), Q(p), S && S.d();
    }
  };
}
function ja(t) {
